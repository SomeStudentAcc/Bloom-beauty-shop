...
import CatallogFilters from "./CatallogFilters";
...
export default function CatalogContainer({ url }: Props) {
  ...
  useEffect(() => {
    if (!urls.length) return; // wait until urls are ready
    ...
    getProds();
  }, [page, setPage, searchParams, urls]);
